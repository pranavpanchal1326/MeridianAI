...
collab_mask = labels['y_path_recommended'] == 0
...
gbr = GradientBoostingRegressor(loss='absolute_error', n_estimators=150, max_depth=4, learning_rate=0.08, subsample=0.8, random_state=42)
gbr.fit(X_tr, y_tr)

mae = mean_absolute_error(y_te, gbr.predict(X_te))
print("Negotiation MAE on Collab ONLY with MAE loss:", mae)
